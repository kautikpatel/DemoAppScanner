...
public class HomeActivity1 extends BaseActivity implements View.OnClickListener, APIcall.ApiCallListner {
    ...
    private void initializeComponents() {
        ...
        llResponse = null;//findViewById(R.id.llResponse);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btnScan) {
            ...
            if (Common.isInternetAvailable(HomeActivity1.this)) {
                APIcall apIcall = new APIcall(HomeActivity1.this);
                String url = AppConstant.API_SUBMIT_DATA + AppConstant.REQUEST_CODE + "=" + barcode.displayValue;
                apIcall.execute(url, APIcall.OPERATION_ID_SUBMIT_DATA, HomeActivity1.this);
            } else {
                Common.displayToastMessageShort(HomeActivity1.this, AppConstant.CONNECTION_ERROR_MSG, false);
            }
        }
    }
    ...
    private boolean isPermissionsGranted() {
        int camera = ContextCompat.checkSelfPermission(HomeActivity1.this,
        ...
        if (!listPermissionsNeeded.isEmpty()) {
            ActivityCompat.requestPermissions(HomeActivity1.this, listPermissionsNeeded.toArray(new String[listPermissionsNeeded.size()]), REQUEST_ID_MULTIPLE_PERMISSIONS);
            return false;
        }
        return true;
    }
            ...
            case REQUEST_ID_MULTIPLE_PERMISSIONS: {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (perms.get(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Common.displayToastMessageShort(HomeActivity1.this, getResources().getString(R.string.error_camera_permission), false);
                    }
                }
            }
        }
    ...
    private void openScanner() {
        Intent intent = new Intent(HomeActivity1.this, ScanActivity.class);
        ...
        if (APIcall.OPERATION_ID_SUBMIT_DATA == operationCode) {
            ...
            try {
                ...
                if (status == 1) {
                    ...
                    Common.displayToastMessageShort(HomeActivity1.this, message, false);
                }
            } catch (Exception e) {
                //showProgress(false);
                Common.displayToastMessageShort(HomeActivity1.this, "Error in data submit", false);
                e.printStackTrace();
            }
        }
    }
